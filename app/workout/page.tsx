...
export default function WorkoutPage() {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-md flex-col overflow-hidden bg-[#0f0f14] px-4 pb-8 pt-6 text-white" style={{ paddingBottom: "calc(2rem + env(safe-area-inset-bottom))" }}>
